    ...
    addComponents([
      {
        '.container': Object.assign(
          { width: '100%' },
          config('theme.container.center', false) ? { marginRight: 'auto', marginLeft: 'auto' } : {},
          _.has(config('theme.container', {}), 'padding')
            ? { paddingRight: config('theme.container.padding'), paddingLeft: config('theme.container.padding') }
            : {}
        ),
      },
      ...atRules,
